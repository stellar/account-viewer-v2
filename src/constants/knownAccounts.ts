type KnownAccount = { name: string; memoType: string; domain: string };

export const knownAccounts: {
  [publicKey: string]: KnownAccount;
} = {
  ...
  GD4J347D3NT267QWCMJDZKJPEQFO2VENLZV6NUHFJQIDVMHGPWYRZ2BC: {
    name: "BitGo",
    domain: "bitgo.com",
    memoType: "id",
  },
  ...
  GDNQAK7B3WQKMEGKJK6FCDKIMKHOGYR7E637GCLFHWJOPCYE6VBALYDF: {
    name: "WhiteStandard",
  ...
  GAESQGK5TTKPT2JY4STRN6MJU56LNHQVBFROGX5GFIWUPK3JHZ5F5FCI: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  GAR6LML2TJ43TRHGG4CZZTASXZ4PWECJQUHNMS3OYX6SCKJ2T6F6WR5Q: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  GAX5KN5SZKIJFSJJ6X2ARE3PUBX63LBGU5FG7SYS4FDM3YALCZUAEBUH: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  GB6UZI3NWBU66O3VPOEVKPIUA7LL23A42KBOXSUIM75T6RJDBMWZXT34: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  GBCAZ6C5UP5G5DVIMYJCFL3OCSM5KJPN6GQJCB45EBWCNPMQX2CZL5YC: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  GBI7IEDTM6EDNURWNLBCU27MVP45OVJE7LRD4PFS67NHTTRKDZQGFLKN: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  ...
  GBPJ35BBTUOXNSGUTB6TQQZWUA7EFZS55KY7Y5Z75TVTN7SPNJKXMPYI: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  GC5ISVO2RW6WOOVCBXDJRTFHI464VM3OAODA2EQIZDL7L2ZETXLRJHCI: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  GCCMMUJ4DNVPDJ7ABDD7JA3KXDN2ISCFPSEXIXXGLXKT3HGXV6PPIQUG: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  GCPVAKXS3VTLE3HPF7B2Y54J3NOVUGTJYGENP3ZNM2MIVKHLZGK22IVQ: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  GDC7UWGW676LQFJLEVWVOYOKFGVTPDQ4LVP27QS3W45XDDT4UQHWHHO4: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  GDMEBQP7NSJBDFGRC4I6HRJODHLLJ6AWZ34YAMY5VIP2BM2QV6OIQZG3: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
  GDOXP56C4SBKZM7NIURUANA63NXTRMJUEOWVR6Q5KJSBGIO7UAWEBSEP: {
    name: "WireX",
    domain: "wirexapp.com",
    memoType: "id",
  },
